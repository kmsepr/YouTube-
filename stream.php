...
// Convert M3U8 to **H.263 + AMR-NB** (3GP format for Symbian)
passthru("ffmpeg -i $url -c:v h263 -b:v 128k -s 176x144 -r 15 -c:a amr_nb -ar 8000 -ac 1 -b:a 12.2k -f 3gp -movflags frag_keyframe+empty_moov -");
?>